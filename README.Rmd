...
# `jogger` is now `[boundr](https://github.com/francisbarton/boundr)`

<!-- badges: start -->
<!-- badges: end -->

## Superseded
I wanted to refactor this package for ages and I finally got round to it. `jogger` is very fragile and needed lots of hacks. It won't work very often nowadays and I don't recommend you install it. I was quite proud of it for a good while, though!
